package cn.stt.magnetic.utils.pager.mybatis;
...
public class Page<T> implements Serializable{
	...
	private int pageSize = 10;//Integer.valueOf(Config.getConfig("page.pageSize")); // 页面大小，设置为“-1”表示不进行分页（分页无效）
	...
	public String toString() {
		...
		if (pageNo == last) {
			sb.append("<li class=\"disabled\"><a href=\"javascript:\" class=\"nextPage\">下一页 &#187;</a></li>\n");
		} else {
			sb.append("<li><a href=\"javascript:\" onclick=\""+funcName+"("+next+","+pageSize+");\" class=\"nextPage\">"
					+ "下一页 &#187;</a></li>\n");
		}
        ...
        sb.append("<style>.nextPage{border-bottom-right-radius: 4px;border-top-right-radius: 4px;margin-right: 1px;} .pagination{margin: 0px 0px 0px 0px;padding: 0px 0px 0px 0px;}</style>");
