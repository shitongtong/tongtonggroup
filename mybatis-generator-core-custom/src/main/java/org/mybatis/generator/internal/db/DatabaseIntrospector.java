...
public class DatabaseIntrospector {
    ...
    private void enhanceIntrospectedTable(IntrospectedTable introspectedTable) {
        try {
            String sql = "show table status like '" + introspectedTable.getFullyQualifiedTable().getIntrospectedTableName() + "'";
            PreparedStatement preparedStatement = databaseMetaData.getConnection().prepareStatement(sql);
            ResultSet rs = preparedStatement.executeQuery();
            while (rs.next()) {
                String comment = rs.getString("COMMENT");
                introspectedTable.setRemarks(comment);
            }
